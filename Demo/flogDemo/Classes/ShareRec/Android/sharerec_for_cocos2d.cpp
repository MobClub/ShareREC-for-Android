...
namespace cn {
	namespace sharerec {
...
#else
		jobject ShareRec::getRecorder() {return 0;}
		
		bool ShareRec::getMethod(JniMethodInfo& mi, const char* name, const char* sig) {return true;}

		void ShareRec::releaseMethod(JniMethodInfo& mi) {}
		
		void ShareRec::setDesignResolution() {}

		bool ShareRec::isAvailable() {return false;}
		...
		bool ShareRec::getLocalVideoPath(jlong videoId, char** path){return true;}
